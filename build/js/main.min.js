...
(function () {
  return new Swiper('.comment__swiper', {
    loop: true,
    spaceBetween: 10,
    navigation: {
      nextEl: '.swiper-button--next',
...
require("./init.js");
var _initTabs = require("./modules/tab/init-tabs");
...
},{"./init.js":1,"./modules/form-validate/form":5,"./modules/init-accordion":11,"./modules/modals/init-modals":12,"./modules/tab/init-tabs":14,"./modules/video.js":16,"./utils/ios-vh-fix":19}],3:[function(require,module,exports){
"use strict";
...
},{"./accordions":3}],12:[function(require,module,exports){
"use strict";
...
function setupVideo(video) {
  ...
  var media = video.querySelector('.video__img');
